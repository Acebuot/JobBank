...
namespace sol_Job_Bank.Controllers
{
    public class ApplicantsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string SearchName, string SearchPhone, string SearchEmail, int? page,
            int? pageSizeID, int? PostingID, int? SkillID, string actionButton, string sortDirection = "asc", string sortField = "Applicant")
        {
            ...
            var applicants = from a in _context.Applicants
               ...
               .Include(a => a.ApplicantPhoto).ThenInclude(a => a.PhotoContentThumb)
        ...
        public async Task<IActionResult> Details(int? id,string returnURL)
        {
            ...
            var applicant = await _context.Applicants
                ...
                .Include(a => a.ApplicantPhoto).ThenInclude(a => a.PhotoContentFull)
        ...
        public async Task<IActionResult> Create([Bind("ID,FirstName,MiddleName,LastName,SIN,Phone,eMail,RetrainingProgramID")] Applicant applicant, 
            string[] selectedOptions,string returnURL, IFormFile thePicture)
        {
            ViewData["returnURL"] = returnURL;
        ...
        public async Task<IActionResult> Edit(int id, string[] selectedOptions,
           string chkRemoveImage,string returnURL, IFormFile thePicture, Byte[] RowVersion)
        {
            ViewData["returnURL"] = returnURL;
